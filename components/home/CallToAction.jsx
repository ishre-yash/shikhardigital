      ...
      >
        <div className="relative z-10 container mx-auto px-4">
          ...
          <p className="text-white/75 font-medium text-lg max-w-md mx-auto text-center select-none">
            7500+ businesses, creatives and everyday Instagram users have worked
            with Gramglow to grow their Instagram account organically and
            manually{" "}
          </p>
          ...
          <div className="flex items-center justify-center mt-8 text-white font-xs select-none">
            ...
            <span className="mr-6 ml-1 text-xs">100% refund policy</span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="#000000"
              className="fill-current text-gray-200"
            ...
            <span className="mr-6 ml-1 text-xs">No Software or bots used</span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="#000000"
              className="fill-current text-gray-200"
            ...
            <span className="mr-6 ml-1 text-xs">Login optional</span>
          </div>
        </div>
      </section>
    </>
