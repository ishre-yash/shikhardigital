...
function Index() {
  return (
    <>
      <footer className="relative py-24 bg-[#010415] overflow-hidden">
        <img className="absolute bottom-0 left-0" src={Footer} alt="" />
        <div className="relative z-10 container mx-auto px-4">
          <div className="flex flex-wrap -m-6">
            <div className="w-full md:w-1/2 lg:w-5/12 p-6">
              <div className="flex flex-col justify-between h-full max-w-sm">
                <div className="mb-11 w-14 flex items-center gap-2">
                  <Fade bottom>
                    <img src={Logo} alt="" />
                  </Fade>
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    <Fade bottom>
                      © Copyright 2022. All Rights Reserved by shikhardigital.
                    </Fade>
                  </p>
                </div>
              </div>
                ...
                <ul>
                  ...
                  <li>
                    <a
                      ...
                      href="/"
                    >
                      <Fade bottom>Customer Support</Fade>
                    </a>
                  </li>
                </ul>
              </div>
                ...
                <div>
                  ...
                  <ul className="mb-6">
                    ...
                    <li className="font-heading font-medium text-base text-white">
                      <Fade bottom>+91 999 999 999</Fade>
                    </li>
                  </ul>
                </div>
