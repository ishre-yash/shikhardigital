          ...
          <div className="md:w-[50%] w-full pt-10 text-center md:text-left">
            ...
            <p class=" text-md font-normal tracking-tighter text-gray-600 dark:text-gray-300 mb-6 w-full md:w-[75%]">
              ...
              <Fade bottom>
                ...
                services and logins increased in 2019. When working with us, you
                may also maintain your 2 Factor Authentication active, which is
                linked to our device and phone number.
              </Fade>
            </p>
            <Fade bottom>
          ...
          <div className="md:w-[50%] w-full pt-10 text-center md:text-left ">
            ...
            <p class=" text-md font-normal tracking-tighter text-gray-600 dark:text-gray-300 mb-6 w-full md:w-[75%]">
              <Fade bottom>
                ...
                addresses. In order to alter data and make it appear as though
                our device is nearby the client’s location, we also utilize GPS
