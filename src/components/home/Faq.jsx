...
function Faq() {
  ...
  return (
    <section className="container mx-auto flex flex-col items-center justify-center py-28 bg-white dark:bg-[#010415]">
      <h1 className="mb-12 max-w-4xl text-center text-4xl font-bold tracking-tighter dark:text-white text-[#1d1d1f] md:text-7xl">
        FAQs
      </h1>
      <section className="w-full rounded-none md:rounded-3xl bg-[#f1f4f6] dark:bg-[#141727] p-10 md:max-w-4xl">
        {faq.map((f, index) => {
          return (
